...
public class Foreman.Models.BedrockLogMessage : Foreman.Models.LogMessage {

    private const string REGEX_STR = """^\[(?P<timestamp>[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}:[0-9]{3}) (?P<log_level>[a-zA-Z]*)\] (?P<message>.*)$""";
    ...
    public BedrockLogMessage.from_output (string line) {
        raw = line;
        try {
