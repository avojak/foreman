...
public class Foreman.Models.ServerProperties : GLib.Object {
    ...
    construct {
        ...
        //  properties_mapping.set (difficulty.property_key, difficulty);
        //  properties_mapping.set (gamemode.property_key, gamemode);
    }
    ...
    public Foreman.Models.Difficulty difficulty { get; set; }
    ...
    public Foreman.Models.GameMode gamemode { get; set; }
